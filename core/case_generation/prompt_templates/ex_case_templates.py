...
참고인은 목격자(witness) 1명, 참고인(reference) 1명, 피고(defendant) 1명으로 구성해주세요.
...
참고인1:이름=홍길동|유형=witness|배경=목격자
참고인2:이름=김철수|유형=reference|배경=관련자
참고인3:이름=이용의|유형=defendant|배경=피고인
